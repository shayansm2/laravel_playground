    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
        @if(config("health.database"))
            <div class="relative bg-white p-6 rounded-3xl w-64 mt-10 shadow-xl">
                <div class="text-white flex items-center absolute rounded-full py-4 px-4 shadow-xl bg-pink-500 right-4 -top-6">
                    <svg version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                         viewBox="0 0 32 32" fill="white" class="h-8 w-8" style="enable-background:new 0 0 32 32;" xml:space="preserve">
                    <style type="text/css">
        ...
        @if(config("health.migrations"))
            <div class="relative bg-white p-6 rounded-3xl w-64 mt-10 shadow-xl">
                    <div class="text-white flex items-center absolute rounded-full py-4 px-4 shadow-xl bg-blue-500 right-4 -top-6">
